...
\section{Filtros Digitais}
	...
	\subsection{Filtros FIR}
		...
		Os valores das atenuacoes $\beta$ dependem tambem do numero de coeficientes $N$ utilizados em um filtro FIR, em que quanto menor esse numero mais compacta será a realização computacional do filtro correspondente.
				
		Um detalhe importante visto na figura () é que o lóbulo principal da janela retangular tem aproximadamente a metade da largura do lóbulo principal da janela \textit{Hamming};
