...
\section{Filtros Digitais}
	...
	\subsection{Filtro Pente - \textit{Comb Filter}}
		...
		\begin{figure}[hbt]
			...
			\caption{Diagrama de Blocos da Estrutura de um Filtro Pente - \textit{Comb Filter}}
		...
		Finalmente temos a função de transferência correspondente ao sistema:
		
		\begin{equation}
			\label{eq3-combfilter}
